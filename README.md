...
| **Degree & Major** | B.Tech in Computer Engineering (Artificial Intelligence) |
| **Core Focus** | Algorithms, Machine Learning Models, Data Processing |
...
I am a Computer Engineering student specializing in **Artificial Intelligence** who loves writing clean code, solving coding challenges, and building real-world software.

- **💻 Core Focus:** Practicing Data Structures & Algorithms (DSA), Object-Oriented Programming (OOP) in Java & C++, and writing fast, optimized code.
- **🤖 Machine Learning:** Building predictive ML models using `scikit-learn`, `Pandas`, `NumPy`, and `Matplotlib` for data cleaning, model training, and testing.
- **🌐 Full-Stack & Web:** Building responsive websites using React and Node.js, working with Linux command-line tools, and managing databases like PostgreSQL and Oracle DB.
- **⚡ Vibe Coding & AI Workflow:** Using AI coding assistants and LLMs to quickly build prototypes, test ideas, and speed up my development process.
...
<img src="https://github-readme-stats-fast.vercel.app/api?username=kambamsairohith22-dev&show_icons=true&theme=tokyonight&hide_border=true" width="450" alt="GitHub Stats" />
...
<img src="https://ghchart.rshah.org/kambamsairohith22-dev" width="100%" alt="Sai Rohith's Contribution Chart" />
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kambam-sai-rohith-36259321a)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kambamsairohith22@gmail.com)
